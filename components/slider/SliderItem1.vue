<template>
  <div class="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
    <div class="min-w-full px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
      <div class="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
        <div>
          <p class=" text-center inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
