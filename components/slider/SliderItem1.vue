...
<section class="text-gray-600 body-font h-screen w-screen bg-accent relative">
  ...
  <img :src="`${$config.BASE_URL}/img/jtd.jpg`" class=" w-full h-full object-cover object-center brightness-75">
  </div>

  <div class="container px-5 py-36 mx-auto flex h-screen relative animate__fadeInUp animate__animated">
    <div class="lg:w-2/3 flex flex-col items-start justify-end">
